              ...
              builder: (context, scrollController) {
                return NotificationListener<DraggableScrollableNotification>(
                  ...
                  child: Container(
                    ...
                    // When showing the login/signup form, RegisterScreen manages
                    // its own layout (Column with sticky footer). When showing
                    // the welcome screen, use the standard scrollable list.
